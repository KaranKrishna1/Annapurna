                ...
                <tr>
                    ...
                    <td>
                        <select name="status">
                            ...
                            <option <?php if ($status == "Work in Progress") echo "selected"; ?> value="Work in Progress">Work in Progress</option>
        ...
        <?php
            if (isset($_POST['submit'])) {
                ...
                if ($changes_detected) {
                    ...
                    $_SESSION['update'] = "<div class='info error'>No Changes Detected in Order Details.</div>";
                    header('location:' . SITEURL . 'admin/manage-order.php');
                }
            }
        ?>
