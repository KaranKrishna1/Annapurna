            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input type="hidden" name="original_full_name" value="<?php echo $full_name; ?>">
...
if(isset($_POST['submit'])) {
    ...
    // Original values
    $original_full_name = $_POST['original_full_name'];
    $original_username = $_POST['original_username'];

    // Check if values have changed
    if($full_name == $original_full_name && $username == $original_username) {
        // No changes detected
